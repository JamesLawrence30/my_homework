...
// create path to draw shape with "lineto"
// outline shape with "stroke"
// fill shape with "fill"

// ** use draw to simply write a new block of text into test2.ps file **

// !! something with destructors on next week? delete each object in "shapes" which is list of pointers to object !!